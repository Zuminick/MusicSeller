            ...
            <div class="Post-card" style="width:200px;">
                    ...
                    <div class="Post-card-body">
                        ...
                        <div class="position-relative p-1">
                            ...
                            <button class="btn wishlist-btn rounded-circle position-absolute bottom-0 end-0" wire:click="addToWishList({{ $post->id }})" style="width:30px; height:30px">
                            <i class="bi-suit-heart-fill"></i> </a>
                        </div>
                    </div>
            </div>
